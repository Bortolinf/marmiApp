// vai ser substituida pela signup_screen.dart

/*
import 'package:marmi_app/firebase/firebase_service.dart';
import 'package:marmi_app/pages/home_page.dart';
import 'package:marmi_app/pages/login_page.dart';
import 'package:marmi_app/utils/alerts.dart';
...
class _CadastroPageState extends State<CadastroPage> {
  final _tNome = TextEditingController(text: "Usuario de Teste");
  ...
  _onClickCadastrar(context) async {
    ...
    if (response.isOk()) {
     // pushReplacement(context, HomePage(fUser.uid));
      pushReplacement(context, LoginPage());
    } else {
