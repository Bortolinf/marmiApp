...
class CalendarCliRec extends StatefulWidget {
  @override
  _CalendarCliRecState createState() => _CalendarCliRecState();
}

class _CalendarCliRecState extends State<CalendarCliRec> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body:
          ...
          //   title: Text("Informe os dias pagos"),
          //    children: <Widget>[
              ...
              child: Kalendar(
                ...
                onTap: (DateTime dateTime, bool isSelected) {
                  ...
                  setState(() {
                    ...
                    //   if (isSelected) {
                    print(appData.wtlDiasRec);
                    if (appData.wtlDiasRec[appData.wtlMesAno] != null &&
                        appData.wtlDiasRec[appData.wtlMesAno]
                      ...
                      if (appData.wtlDiasRec[appData.wtlMesAno] == null) {
                        appData.wtlDiasRec[appData.wtlMesAno] = [dateTime.day];
                      } else {
                        appData.wtlDiasRec[appData.wtlMesAno].add(dateTime.day);
                      }
                      print(appData.wtlDiasRec);
                    }
                  });
